...
SCHEDULER_ADMISSION_TIMEOUT = _get_float("SCHEDULER_ADMISSION_TIMEOUT", 300.0)
SCHEDULER_ADMISSION_POLL_INTERVAL = _get_float("SCHEDULER_ADMISSION_POLL_INTERVAL", 0.05)
